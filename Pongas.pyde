...
def draw():
    ...
    global xpos, ypos,  trajektoriax, trajektoriay, kierunek_pilki, reset_pilki
    #iteracja_programu +=1
    ...
    def reset_pilki():
        ...
        ypos = height / 2
        import random 
        trajektoriax = random.choice([-5, -4, -3, -1, -2, 1, 2, 3, 4])
        trajektoriay = random.choice([-5, -4, -3, -1, -2, 1, 2, 3, 4])
